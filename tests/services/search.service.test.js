...
describe("SearchService", () => {
    ...
    it("should normalize keyword and tags before searching", async () => {
        ...
        fakeSearchRepository.searchEvents.mockResolvedValue(searchResult);
        // Act
        ...
        const firstCall = fakeSearchRepository.searchEvents.mock.calls[0];
